...
def get_dataloader(data_X, data_X_test, y, y_test, batch_size=64, val_fraction=0.2, pca_components=200, i=0):
    '''Performs PCA and returns dataloaders'''
    
    # Standardization
    #scaler = StandardScaler()
    #scaler.fit(data_X)
    #data_X = scaler.transform(data_X, copy=False)
